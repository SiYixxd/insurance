...
public class NewsServiceImpl implements NewsService {
    ...
    @Override
    //用户分页查看咨询
    public  List<UserNews> userFindPager(Map<String, Object> map){
        int pageIndex =Integer.valueOf(map.get("page").toString());
        int pageSize = 5;
        List<UserNews> userPageageNews = newsDao.userFindPager(map,new RowBounds(pageIndex*pageSize, pageSize));
